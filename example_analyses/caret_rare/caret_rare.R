...
save(
  glmn_spline_res,
  file = file.path("example_analyses", "caret_rare", "base_fits", "caret_rare_glmnet.RData"),
  compress = "xz",
  compression_level = 9
)
...
save(
  fda_manual_res,
  file = file.path("example_analyses", "caret_rare", "base_fits", "caret_rare_fda.RData"),
  compress = "xz",
  compression_level = 9
)
...
save(
  svm_res,
  file = file.path("example_analyses", "caret_rare", "base_fits", "caret_rare_svm.RData"),
  compress = "xz",
  compression_level = 9
)
...
save(
  nnet_res,
  file = file.path("example_analyses", "caret_rare", "base_fits", "caret_rare_nnet.RData"),
  compress = "xz",
  compression_level = 9
)
...
save(
  knn_res,
  file = file.path("example_analyses", "caret_rare", "base_fits", "caret_rare_knn.RData"),
  compress = "xz",
  compression_level = 9
)
...
save(
  bart_res,
  file = file.path("example_analyses", "caret_rare", "base_fits", "caret_rare_bart.RData"),
  compress = "xz",
  compression_level = 9
)
...
save(lgb_res, file = file.path("example_analyses", "caret_rare", "base_fits", "caret_rare_lgb.RData"), compress = "xz", compression_level = 9)
